...
/*            NULL, */                                   /* network interface eth0, eth1, etc. NULL is default.*/
	    "eth1",                                /* network interface eth0, eth1, etc. NULL is default.*/
            errbuf);                                 /* error buffer */
...
void usage(){
    fprintf(stderr, "cxn_pgn 0.1 by cephexin. Protected under GPL.\nusage: cxn_pgn -p <payload file> -t <TCP/UDP file> -i <IP file> -e <Ethernet file>\n");
}
